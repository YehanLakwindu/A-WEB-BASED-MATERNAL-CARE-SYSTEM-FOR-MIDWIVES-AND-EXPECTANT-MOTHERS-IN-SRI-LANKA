<x-app-layout>
  <x-slot name="header">
      <h2 class="text-xl font-semibold leading-tight text-gray-800">
          Enter Mother ID to View Digital ID
      </h2>
  </x-slot>
  ...
  <div class="py-12">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="p-6 bg-white shadow-md sm:rounded-lg">
              <h3 class="text-lg font-semibold">Enter Mother ID</h3>
              ...
              <!-- Form to input the Mother ID -->
              <form action="{{ route('mother.digitalId') }}" method="GET">
                  <div class="mb-4">
